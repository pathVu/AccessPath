package com.pathvu.accesspath2020.Adapter
 ...
 */
class PlacesAutoCompleteAdapter(mContext: Context, val placesApi: PlaceAPI) : ArrayAdapter<Place>(mContext, R.layout.autocomplete_list_item), Filterable {
