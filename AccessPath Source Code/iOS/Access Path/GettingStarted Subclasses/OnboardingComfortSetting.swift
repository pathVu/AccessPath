 ...
 */
class OnboardingComfortSetting: UIViewController {
     ...
     * Check the type and change the button title and dismissed to back controller
     */
     ...
     */
    @IBAction func veryUncomfortableButtonPressed() {
     ...
     */
    @IBAction func mostlyComfortableButtonPressed() {
     ...
     */
    @IBAction func veryComfortableButtonPressed() {
     ...
     */
    @IBAction func completelyComfortableButtonPressed() {
    ...
    // Changed By Chetu
    // add Type value pass uncomfortable,comfortable
    func savedUserRouteComfortableTypeValue(comfortLevel:Int){
        ...
        case 3:
            ...
            break
            /*
            // case 4 curb ramp code not used
        case 4:
        ...
        *case 6 & 7 removed from comfort setting
        // case 6 Obstruction code not used
        case 6:
            ...
            // case 7 Instruction code not used
        case 7:
    ...
    /*
     * Changed By Chetu
     * add Type value get loadDataGetComfortValuemethod set tick and untick uncomfortable,comfortable
